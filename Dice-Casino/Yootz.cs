...
public static void Yootzgame()
{
    ...
    //## for the 
    if hasPlayed == "yes"||"Yes";
    {
        GamePlay//these are functions that are not being called
    }
    else if hasPlayed == "no"||"No";
    {
        GameRules//these are functions that are not being called
    }
    else
    {
...
{//#this is writing out the rules before using the GamePlay function.
    Console.WriteLine("Starting off we have the basics of the gameplay which is how to roll the dice. \n" 
